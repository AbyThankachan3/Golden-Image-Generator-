...
build_critical_set() {
    ...
    local CRITICAL_PATTERNS=("systemd" "libnss-" "libpam-" "grub-" "linux-" "curl" "wget" "lshw" "openssh" "sudo" "perl" "needrestart" "coreutils" "busybox" "zstd" "ubuntu-server" "ubuntu-minimal" "dpkg" "apt" "bash" "cron" "logrotate" "rsyslog")
